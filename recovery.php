	...
	<div class="row">
		<div class="col-md-6">
			...
			<div class="panel panel-default">
				<div class="panel-heading">Solicitar codigo</div>
				<div class="panel-body">
					<form role="form" method="post" action="action/getcode.php">
		...
		<div class="col-md-6">
			...
			<br>
			<div class="panel panel-default">
				<div class="panel-heading">Ya tengo un codigo</div>
				<div class="panel-body">
					<form role="form" method="post" action="action/recoverycode.php">
					  	<div class="form-group">
					    	<label for="exampleInputEmail1">Correo electronico</label>
